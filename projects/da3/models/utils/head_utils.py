...
"""Head utility functions: Permute, create_uv_grid, position_grid_to_embed,
   custom_interpolate, make_sincos_pos_embed."""
...
def create_uv_grid(
    ...
    normalized by the diagonal of the plane.
    """
...
def position_grid_to_embed(
    ...
    """Convert position grid to sinusoidal positional embedding.

    Args:
        pos_grid: (H, W, 2)
        embed_dim: output channel dimension
        omega_0: base frequency (default 100, NOT 10000)
